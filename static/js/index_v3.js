...
function createGalleryItem(image) {
    ...
    img.src = '/uploads/' + (image.thumbnail_url || image.url);
...
function openImageModal(image) {
    ...
    modalBody.innerHTML = `
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: start;">
            <div>
                <img src="/uploads/${image.url}" alt="${escapeHtml(image.title || 'Untitled')}" 
    ...
    container.innerHTML = `
        <div class="featured-content">
            <div class="featured-image-container">
                <img src="/uploads/${image.url}" alt="${escapeHtml(image.title || 'Featured Image')}">
            </div>
